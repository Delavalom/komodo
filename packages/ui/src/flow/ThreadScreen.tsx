...
import type { JudgementThread, ReviewActions } from "@komodo/core/store";
import { CHIP_CLASS, REPLY_TINT } from "../kit";
            ...
            <div key={m.id}>
              <div className="flex items-baseline gap-2 mb-1.5">
                ...
                <span className="text-[11px] text-text-faint">
                  {ROLE_VERB[m.role]} · {when(m.createdAt)}
                </span>
              </div>
